# ISO 27001:2022 Annex A Controls — SecureTech

> 📖 **Instructions:** ISO 27001:2022 has 93 controls organized into 4 themes. You don't need to document all 93 — focus on the most relevant controls for a cybersecurity startup. Aim for 6-10 controls per theme (covering the most impactful ones).
>
> For each control, document what it requires, SecureTech's current state, and any notes.

---

## Organizational Controls (A.5 — A.8)

*Policies, roles, asset management, access control, supplier relationships, and information security in project management.*
...
*Screening, awareness, training, disciplinary process, responsibilities after termination, remote working, and event reporting.*
...
*Physical security perimeters, entry controls, securing offices, physical security monitoring, protecting against threats, working in secure areas, clear desk/screen.*
...
*Technical security controls: endpoint devices, privileged access, access restriction, source code, malware protection, vulnerability management, logging, network security, encryption, secure development, etc.*
